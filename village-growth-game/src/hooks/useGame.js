...
export function useGame() {
  ...
  const actions = useMemo(
    () => ({
      ...
      buyItem: (id) => dispatch({ type: 'BUY_ITEM', id }),
      ...
      warRecruit: (id, qty) => dispatch({ type: 'WAR_RECRUIT', id, qty }),
      warDeployGeneral: (terrId, genId) => dispatch({ type: 'WAR_DEPLOY_GENERAL', terrId, genId }),
      warAttack: (targetId, fromId) => dispatch({ type: 'WAR_ATTACK', targetId, fromId }),
      warEndTurn: () => dispatch({ type: 'WAR_END_TURN' }),
